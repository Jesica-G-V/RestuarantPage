...
class Atri:
	def __init__(self, state: Any):
		...
		self.LogoIcon = state["LogoIcon"]
		self.Tabs = state["Tabs"]
		self.Description = state["Description"]
		self.MainSection = state["MainSection"]
		self.TitleNDescription = state["TitleNDescription"]
		self.ButtonGroup = state["ButtonGroup"]
		...
		self.LogoIconAsset = state["LogoIconAsset"]
		self.Cart = state["Cart"]
		self.Page = state["Page"]
		self.Menu = state["Menu"]
		self.Home = state["Home"]
		self.About = state["About"]
		self.Title2 = state["Title2"]
		self.Title1 = state["Title1"]
	...
	@property
	def LogoIcon(self):
		self._getter_access_tracker["LogoIcon"] = {}
		return self._LogoIcon
	@LogoIcon.setter
	def LogoIcon(self, new_state):
		self._setter_access_tracker["LogoIcon"] = {}
		global default_state
		self._LogoIcon = Flex(new_state, default_state["LogoIcon"])

	@property
	def Tabs(self):
		self._getter_access_tracker["Tabs"] = {}
		return self._Tabs
	@Tabs.setter
	def Tabs(self, new_state):
		self._setter_access_tracker["Tabs"] = {}
		global default_state
		self._Tabs = Flex(new_state, default_state["Tabs"])
	...
	def Description(self, new_state):
		...
		global default_state
		self._Description = Flex(new_state, default_state["Description"])

	@property
	def MainSection(self):
		self._getter_access_tracker["MainSection"] = {}
		return self._MainSection
	@MainSection.setter
	def MainSection(self, new_state):
		self._setter_access_tracker["MainSection"] = {}
		global default_state
		self._MainSection = Flex(new_state, default_state["MainSection"])

	@property
	def TitleNDescription(self):
		self._getter_access_tracker["TitleNDescription"] = {}
		return self._TitleNDescription
	@TitleNDescription.setter
	def TitleNDescription(self, new_state):
		self._setter_access_tracker["TitleNDescription"] = {}
		global default_state
		self._TitleNDescription = Flex(new_state, default_state["TitleNDescription"])

	@property
	def ButtonGroup(self):
		self._getter_access_tracker["ButtonGroup"] = {}
		return self._ButtonGroup
	@ButtonGroup.setter
	def ButtonGroup(self, new_state):
		self._setter_access_tracker["ButtonGroup"] = {}
		global default_state
		self._ButtonGroup = Flex(new_state, default_state["ButtonGroup"])

	@property
	def ImageSection(self):
		self._getter_access_tracker["ImageSection"] = {}
		return self._ImageSection
	@ImageSection.setter
	def ImageSection(self, new_state):
		self._setter_access_tracker["ImageSection"] = {}
		global default_state
		self._ImageSection = Flex(new_state, default_state["ImageSection"])

	@property
	def FavAppsSection(self):
		self._getter_access_tracker["FavAppsSection"] = {}
		return self._FavAppsSection
	@FavAppsSection.setter
	def FavAppsSection(self, new_state):
		self._setter_access_tracker["FavAppsSection"] = {}
		global default_state
		self._FavAppsSection = Flex(new_state, default_state["FavAppsSection"])

	@property
	def AppIconsGroup(self):
		self._getter_access_tracker["AppIconsGroup"] = {}
		return self._AppIconsGroup
	@AppIconsGroup.setter
	def AppIconsGroup(self, new_state):
		self._setter_access_tracker["AppIconsGroup"] = {}
		global default_state
		self._AppIconsGroup = Flex(new_state, default_state["AppIconsGroup"])
	...
	@property
	def LogoIconAsset(self):
		self._getter_access_tracker["LogoIconAsset"] = {}
		return self._LogoIconAsset
	@LogoIconAsset.setter
	def LogoIconAsset(self, new_state):
		self._setter_access_tracker["LogoIconAsset"] = {}
		global default_state
		self._LogoIconAsset = Image(new_state, default_state["LogoIconAsset"])
	...
	@property
	def Title2(self):
		self._getter_access_tracker["Title2"] = {}
		return self._Title2
	@Title2.setter
	def Title2(self, new_state):
		self._setter_access_tracker["Title2"] = {}
		global default_state
		self._Title2 = TextBox(new_state, default_state["Title2"])

	@property
	def Title1(self):
		self._getter_access_tracker["Title1"] = {}
		return self._Title1
	@Title1.setter
	def Title1(self, new_state):
		self._setter_access_tracker["Title1"] = {}
		global default_state
		self._Title1 = TextBox(new_state, default_state["Title1"])

	@property
	def DescriptionText(self):
		self._getter_access_tracker["DescriptionText"] = {}
		return self._DescriptionText
	@DescriptionText.setter
	def DescriptionText(self, new_state):
		self._setter_access_tracker["DescriptionText"] = {}
		global default_state
		self._DescriptionText = TextBox(new_state, default_state["DescriptionText"])
	...
	def Title(self, new_state):
		...
		global default_state
		self._Title = TextBox(new_state, default_state["Title"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex6": self._Flex6,
			"Logo": self._Logo,
			"LogoIcon": self._LogoIcon,
			"Tabs": self._Tabs,
			"Description": self._Description,
			"MainSection": self._MainSection,
			"TitleNDescription": self._TitleNDescription,
			"ButtonGroup": self._ButtonGroup,
			"ImageSection": self._ImageSection,
			"FavAppsSection": self._FavAppsSection,
			"AppIconsGroup": self._AppIconsGroup,
			"Flex15": self._Flex15,
			"Flex36": self._Flex36,
			"Flex21": self._Flex21,
			"Flex38": self._Flex38,
			...
			"LogoIconAsset": self._LogoIconAsset,
			"Cart": self._Cart,
			"Page": self._Page,
			"Menu": self._Menu,
			"Home": self._Home,
